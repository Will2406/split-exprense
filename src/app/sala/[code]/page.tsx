  ...
  return (
    <div className="flex flex-col flex-1 animate-fade-in">
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-gray-200/80 sticky top-0 z-40">
        <div className="max-w-screen-xl mx-auto px-3 sm:px-4 lg:px-6 py-3 flex items-center justify-between gap-2">
      ...
      {/* Participantes */}
      <div className="max-w-screen-xl mx-auto w-full px-3 sm:px-4 lg:px-6 pt-4">
      ...
      {/* Tabs (solo mobile) */}
      <div className="lg:hidden max-w-screen-xl mx-auto w-full px-3 sm:px-4 pt-3">
      ...
      <div className="max-w-screen-xl mx-auto w-full px-3 sm:px-4 lg:px-6 py-4 flex-1">
        {/* Mobile: tabs */}
      ...
      <div className="sticky bottom-0 bg-gradient-to-t from-white via-white/95 to-transparent pt-4 pb-6 px-3 sm:px-4 lg:px-6">
